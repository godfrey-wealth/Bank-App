package com.example.bankingsystemproject.security.auth.isauthenticated;
...
public class isAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.bankingsystemproject.security.auth.isauthenticated.isAuthenticated)")
    public void annotatedMethod(){

    }

    @Pointcut("@within(com.example.bankingsystemproject.security.auth.isauthenticated.isAuthenticated)")
